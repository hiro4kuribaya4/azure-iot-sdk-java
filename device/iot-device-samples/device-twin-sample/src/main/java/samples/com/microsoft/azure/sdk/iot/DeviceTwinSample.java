...
public class DeviceTwinSample
{
    ...
    protected static class onMileageChange implements PropertyCallBack
    {
        @Override
            ...
            throws IOException, URISyntaxException
    {
        ...
        //DeviceTwin client = new DeviceTwin(connString, protocol);
        ...
        client.startDeviceTwin(eventCallback, 1, device, null);

        device.hasDesiredProperty(new Property("mileage", null), new onMileageChange(), null);
        device.hasDesiredProperty(new Property("Oil(ml)", null), device, null);

       // device.hasReportedProp(new Property("temp", 100));
       // device.hasReportedProp(new Property("pressure", 10.5));
        device.hasReportedProp(new Property("name", "Phone"));


        client.sendReportedProperties(device.getReportedProp());
        //client.subscribeToDesiredPorperties(device.getDesiredProp());
